...
model.add(keras.layers.Conv1D(120, input_shape=(XTrain.shape[1:]), kernel_size=1))
...
history = model.fit(x=XTrain, y=yTrain, epochs=150, batch_size=5, validation_data=(XTest, yTest), verbose=2)
